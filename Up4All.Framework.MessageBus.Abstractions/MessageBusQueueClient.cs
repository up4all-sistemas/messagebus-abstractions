...
{
    public abstract class MessageBusQueueClient : MessageBusClientBase, IMessageBusQueueClient
    {
        public MessageBusQueueClient(IOptions<MessageBusOptions> messageBusOptions) : base(messageBusOptions)
        {
        }
